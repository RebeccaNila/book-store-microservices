package dev.nila.orderservice.web.exception;

import dev.nila.orderservice.domain.InvalidOrderException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // when we send invalid request, will happen this error
    @Override
