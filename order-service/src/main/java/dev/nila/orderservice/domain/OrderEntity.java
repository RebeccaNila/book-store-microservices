...
import dev.nila.orderservice.domain.models.Address;
import dev.nila.orderservice.domain.models.Customer;
import dev.nila.orderservice.domain.models.OrderStatus;
...
@Table(name = "orders")
@Data
@EqualsAndHashCode(exclude = "items") // ✅ Exclude the collection
@ToString(exclude = "items") // ✅ Also exclude from toString
