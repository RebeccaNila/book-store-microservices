...
import static dev.nila.orderservice.testdata.TestDataFactory.*;
...
@WebMvcTest(OrderController.class) // test the order controller, web component only
public class OrderControllerUnitTests {
    // orderController class we need two bean
    // to create bean
    // while creating application context by default using @WebMvcTest
    // it will load all the web component and framework levels web related things
    // order needs OrderService and SecurityService
    @MockitoBean
